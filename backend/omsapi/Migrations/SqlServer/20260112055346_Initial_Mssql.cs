        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlPrefix = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_delete = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    index_image = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    uploader = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    contract_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    contract_name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    latest_transaction_date = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    period_key = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    stat_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    total_contracts = table.Column<int>(type: "int", nullable: false),
                    total_contracts_growth = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    amount_completion_rate = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    received_rate = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    total_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    submitted_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    project_code = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    swimlaneId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    startColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    endColor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    bid_project_id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    tender_type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    bid_bond = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    budget = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    bid_start_time = table.Column<DateTime>(type: "datetime2", nullable: true),
                    bid_end_time = table.Column<DateTime>(type: "datetime2", nullable: true),
                    tender_start_time = table.Column<DateTime>(type: "datetime2", nullable: true),
                    open_bid_time = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bid_time = table.Column<DateTime>(type: "datetime2", nullable: true),
                    leader = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    owner = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    estimated_close_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parent_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConversationKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    LastMessageContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    LastMessageType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConversationKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SenderConnectionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SenderUserId = table.Column<long>(type: "bigint", nullable: true),
                    SenderUserName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Leader = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgShortName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OrgAbbr = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    LicenseCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LicenseFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthLetterFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Query = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ViewRoles = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CallRoles = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ManageRoles = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetentionPeriod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SecurityLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FormItems = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    RequiresLogin = table.Column<bool>(type: "bit", nullable: false),
                    LimitOnePerUser = table.Column<bool>(type: "bit", nullable: false),
                    ViewRoleIds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FillRoleIds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ManageRoleIds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KbId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Size = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiBindings = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    chapter_type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    analysis_result = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    risk_level = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    is_veto = table.Column<bool>(type: "bit", nullable: false),
                    score_weight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    sort_order = table.Column<int>(type: "int", nullable: false),
                    extractions_json = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    css_class = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    list_class = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    remark = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
