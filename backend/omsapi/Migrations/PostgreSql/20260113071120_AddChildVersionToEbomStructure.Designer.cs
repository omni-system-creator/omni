...
namespace omsapi.Migrations.PostgreSql
{
    ...
    [Migration("20260113071120_AddChildVersionToEbomStructure")]
    partial class AddChildVersionToEbomStructure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("omsapi.Models.Entities.Pdm.PdmEbomItem", b =>
                {
                    ...
                    b.ToTable("pdm_ebom_items");
                });

            modelBuilder.Entity("omsapi.Models.Entities.Pdm.PdmEbomStructure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
