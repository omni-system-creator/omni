    ...
    <n-card class="collapse-show-box">
      ...
      <div v-for="eventName in EventLife" :key="eventName">
        <p>
          ...
          <br />
          <span class="func-keyword">async {{ eventName }}</span> (e, components, echarts, node_modules, http) {
        </p>
        <p class="go-ml-4">
          ...
          <n-tabs v-model:value="editTab" type="card" tab-style="min-width: 100px;">
            ...
            >
              ...
              <p class="go-pl-3">
                ...
                <span class="func-keyNameWord">{{ eventName }}(e, components, echarts, node_modules, http)&nbsp;&nbsp;{</span>
              </p>
              <!-- 编辑主体 -->
