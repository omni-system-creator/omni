...
export const useChartHistoryStore = defineStore({
  ...
  getters: {
    ...
    getUseChartHistoryList(): Array<HistoryItemType> {
      return this.useChartHistoryList
    }
  },
  actions: {
    /**
    ...
    createShowHistory(item: Array<CreateComponentType | CreateComponentGroupType>) {
      ...
      // * 更新 useChartHistoryList
      updateUseChartHistoryList(newData: Array<HistoryItemType>) {
        this.useChartHistoryList = newData
      }
  }
})
