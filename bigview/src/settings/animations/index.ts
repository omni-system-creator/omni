export const animations = [
  ...
  },
  {
    ...
    children: [
      { label: '渐显', value: 'fadeIn' },
      { label: '向右移出', value: 'fadeInLeft' },
      { label: '向左移出', value: 'fadeInRight' },
      { label: '向上移出', value: 'fadeInUp' },
      { label: '向下移出', value: 'fadeInDown' },
      { label: '向右长距移出', value: 'fadeInLeftBig' },
      { label: '向左长距移出', value: 'fadeInRightBig' },
      { label: '向上长距移出', value: 'fadeInUpBig' },
      { label: '向下长距移出', value: 'fadeInDownBig' },
      { label: '旋转移出', value: 'rotateIn' },
      { label: '左顺时针旋转', value: 'rotateInDownLeft' },
      { label: '右逆时针旋转', value: 'rotateInDownRight' },
      { label: '左逆时针旋转', value: 'rotateInUpLeft' },
      { label: '右逆时针旋转', value: 'rotateInUpRight' },
      { label: '弹出', value: 'bounceIn' },
      { label: '向右弹出', value: 'bounceInLeft' },
      { label: '向左弹出', value: 'bounceInRight' },
      { label: '向上弹出', value: 'bounceInUp' },
      { label: '向下弹出', value: 'bounceInDown' },
      { label: '光速从右移出', value: 'lightSpeedInRight' },
      { label: '光速从左移出', value: 'lightSpeedInLeft' },
      { label: '光速从右退出', value: 'lightSpeedOutRight' },
      { label: '光速从左退出', value: 'lightSpeedOutLeft' },
      { label: 'Y轴旋转', value: 'flip' },
      { label: '中心X轴旋转', value: 'flipInX' },
      { label: '中心Y轴旋转', value: 'flipInY' },
      { label: '左长半径旋转', value: 'rollIn' },
      { label: '由小变大移出', value: 'zoomIn' },
      { label: '左变大移出', value: 'zoomInLeft' },
      { label: '右变大移出', value: 'zoomInRight' },
      { label: '向上变大移出', value: 'zoomInUp' },
      { label: '向下变大移出', value: 'zoomInDown' },
      { label: '向右滑动展开', value: 'slideInLeft' },
      { label: '向左滑动展开', value: 'slideInRight' },
      { label: '向上滑动展开', value: 'slideInUp' },
      { label: '向下滑动展开', value: 'slideInDown' }
