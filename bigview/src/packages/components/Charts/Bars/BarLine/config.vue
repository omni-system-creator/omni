<template>
  ...
  >
    ...
    <SettingItemBox name="图形" v-if="item.type == 'bar'">
      ...
      <SettingItem name="柱条颜色">
    <n-color-picker v-model:value="item.itemStyle.color" :modes="['hex']" size="small" />
  </SettingItem>
  <SettingItem name="柱条描边颜色">
    <n-color-picker v-model:value="item.itemStyle.borderColor" size="small"  :modes="['hex']"/>
  </SettingItem>
    </SettingItemBox>
