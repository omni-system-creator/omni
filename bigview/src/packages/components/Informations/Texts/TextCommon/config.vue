  ...
  <collapse-item name="样式" :expanded="true">
    <setting-item-box name="文字">
      ...
      <setting-item name="水平对齐">
        <n-select v-model:value="optionData.horizonalAlign" size="small" :options="horizonalAlignOptions" />
      </setting-item>
      <setting-item name="垂直对齐">
        <n-select v-model:value="optionData.verticalAlign" size="small" :options="verticalAlignOptions" />
      </setting-item>
      <setting-item name="文本方向">
        <n-select v-model:value="optionData.writingMode" size="small" :options="verticalOptions" />
      </setting-item>
      <setting-item name="文本对齐">
