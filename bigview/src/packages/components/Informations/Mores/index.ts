...
import { RemoteDesktopConfig } from './RemoteDesktop/index'
import { VideoConfig } from './Video/index'
import { WordCloudConfig } from './WordCloud/index'

export default [ImageConfig, ImageCarouselConfig, VideoConfig, IframeConfig, RemoteDesktopConfig, WordCloudConfig]
